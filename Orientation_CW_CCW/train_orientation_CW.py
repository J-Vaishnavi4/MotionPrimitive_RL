...
def main():
    ...
    model = ppo.PPO("MlpPolicy", env, verbose=1)#,tensorboard_log="./tensorboard/PPO/orientation_MP_CW/")
    best = 0
    for i in range(20):
        print("iteration: ",i)
        ...
        if (temp[0]>best):
            model.save("./best_models/PPO/orientation_MP_CW")
            best=temp[0]
        if (i%9==0):
            model.save("./models/PPO/orientation_MP_CW")
    model.save("./models/PPO/orientation_MP_CW")
